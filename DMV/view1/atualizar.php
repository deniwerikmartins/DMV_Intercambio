...
<main>
<h1>Atualize seus dados cadastrais</h1>
<form method="POST"
	...
	<fieldset>
		...
		<p>
			<label>Data de Nascimento: <input type="date" size="25"	name="nascimento">
			</label>
		</p>

		<p>
			<label>Nacionalidade: <input type="text" size="25" name="nacionalidade">
			</label>
		</p>
		...
		<p>
			<label>Nome completo da mãe: <input type="text" size="25"	name="nomedamae">
			</label>
		</p>
		...
		<p>
			<label>Nome completo do pai: <input type="text" size="25"	name="nomemae">
			</label>
		</p>

		<p>
			<label>Telefones: <span>Cel:</span> <input type="text" size="25"
	name="celpai"> <span>Comercial:</span><input type="text"	name="compai">
			</label>
		</p>
		...
		<p>
			<label>Contato em caso de emergência:<input type="text" name="emergencia" size="50"></label>
		</p>

		<p>
			<label>Telefones: <span>Cel:</span> <input type="tel" size="25"
				name="celemergencia"> <span>Comercial:</span><input type="tel"	name="comemergencia">
			</label>
		</p>
